...
Route::prefix('organisation')->group(function () {
    ...
    // New route for deleting a data collection

    Route::delete('{organisation_id}/delete-collection/{collection_id}', [DataCollection\DeleteCollectionController::class, 'delete']);
